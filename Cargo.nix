  ...
  internal = rec {
    ...
    crates = {
      "rustc-std-workspace-core" = rec {
        ...
        version = "1.0.1";
        edition = "2021";
        sha256 = "0mb9fhvxj2s1dbagbhv3q3z21zvb2k3n441isvr54vqkfjrlb75a";
      ...
      "rustc-std-workspace-std" = rec {
        ...
        version = "1.0.1";
        edition = "2015";
        sha256 = "1vq4vaclamwhk0alf4f7wq3i9wxa993sxpmhy6qfaimy1ai7d9mb";
        libName = "std";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "unicode-width" = rec {
        ...
        resolvedDefaultFeatures = [ "cjk" "core" "default" "no_std" "rustc-dep-of-std" "std" ];
      };
    };
